  ...
  return (
    <div className='py-20 w-full relative'>
      <div className='mx-auto px-4 sm:px-8 lg:px-8'>
        <div className='grid lg:grid-cols-2 grid-cols-1 w-full relative lg:h-[40rem]'>
          <div
          ...
          <div className='w-full flex justify-center lg:justify-end mt-8 lg:mt-0'>
            <div className='w-full h-[20rem] sm:h-[30rem] md:h-[35rem] lg:h-[40rem] md:max-w-[50rem] lg:max-w-[60rem]'>
